...
% Last Modified by GUIDE v2.5 09-Apr-2018 03:19:12
...
% handles    structure with handles and user data (see GUIDATA)
global y;
orig_name=get(handles.edit1,'string')
orig_name=strcat(orig_name,'.wav')
audiowrite(orig_name,y,10000)
